...
<head>
 ...
 <section class="search-sec">
    <div class="container">
      <form action="search_senior.php" method="GET" novalidate="novalidate">
        <div class="row">
          <div class="col-lg-12">
            <div class="row">
    ...
    <!--========contact senior page starts here======-->
      ...
      <div class="col-md-12 col-md-offset-1">
        <div class="row">
          ...
          <div class="col-sm-3 margin40">
            ...
            <div class="work-desc">
              <h3><a>Ananya Sharma,<br> BTech (IT)</a></h3>
              <span><a href="https://www.linkedin.com/in/vertika-sahu-687305205/">Connect on LinkedIn</a></span>
            </div>work desc
          ...
          <div class="col-sm-3 margin40">
            ...
            <div class="work-desc">
              <h3><a>Kritika Pandey,<br> BBA</a></h3>
              <span><a href="https://www.linkedin.com/in/vertika-sahu-687305205/">Connect on LinkedIn</a></span>
            </div>work desc
          </div>speakers col end
          ...
          <div class="col-sm-3 margin40">
            ...
            <div class="work-desc">
              <h3><a>Divya Shukla,<br> BSc (Chemistry)</a></h3>
              <span><a href="https://www.linkedin.com/in/vertika-sahu-687305205/">Connect on LinkedIn</a></span>
            </div><work desc
          </div>speakers col end
          --> 
