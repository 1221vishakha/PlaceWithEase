                ...
                <div class="table-responsive">
                    <table id="mytable" class="table table-bordred table-striped">
                        ...
                        <tbody>
                            ...
                            $sql="SELECT * FROM qa WHERE questioner='$email'";
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                              ...
                              //  $s_email = $row['posted_by']; 
                                ...
                                $link ="view_j.php?qid=$id";

                                echo '
                                <tr>
                                <td>'.$i.'</td>
                                <td>'. substr($ques,0,35) .'...</td>
                                <td>'.substr($ans,0,35).'...</td>
                                <td>'.$date.'</td>
                                <td>          
                                  <a href="'.$link.'" class="btn btn-primary ml-3 p-0 text-light" 
