                ...
                <div class="col-md-4 col-12 container-fluid">
                    <div class="single_product shadow text-center p-1 bg-light">
                        <div class="product_img">
                            <a href="spam.php"><img src="https://iipgh.org/new/wp-content/uploads/2020/08/spam-email.png"
                            width="95%" height="30%" alt=""></a>
                        </div>
                        <div class="product-caption ">
                            <h4><a href="spam.php" class="text-dark">SPAM CHECK</a></h4>
                        </div>
                    </div>
                </div>
            </div>
