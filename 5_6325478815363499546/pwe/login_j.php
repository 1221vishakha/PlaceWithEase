            ...
            if ($num == 1) {
              while($row=mysqli_fetch_assoc($result)) {
                ...
                elseif(password_verify($pass, $row['password'])) {
                  ...
                  $sql = "Select name from junior where email='$email'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  <div class="card-body p-4 p-lg-5 text-black"> 
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                      ...
                      <div class="d-flex align-items-center mb-3 pb-1">                                  
                        <span class="h1 fw-bold mb-0 ft"><i>Login: Junior</i></span>
                      </div>
                      ...
                      <a class="small text-muted" href="forgetpassword_j1.php">Forgot password?</a>
                      <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="register_j1.php" style="color: #393f81;">Register here</a></p>
