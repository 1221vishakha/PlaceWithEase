...
<html lang="en">
  ...
  <body>
    ...
    <?php
      ...
      $reg = false;
      static $mail = 0;
      $nameErr = $emailErr = $gyearErr = $courseErr = $passErr = $cpassErr = $codeErr = "";
      $name = $email = $gyear = $course = $pass = $cpass = $code = "";
      $check = 0;
      if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($_POST["email"])) {
          ...
          if (filter_var($email, FILTER_VALIDATE_EMAIL))
          {
            ...
            {
              $emailErr = "Enter email provided by institution";
            }
            else {
              ...
              if ($num != 0) {
                ...
                $nameErr = $gyearErr = $courseErr = $passErr = $cpassErr = $codeErr = "";
                $name = $gyear = $course = $pass = $cpass = $code = "";
        ...
        if($check == 6)   
        {
          ...
          if (mail($to_email, $subject, $body, $headers)) {
            ...
            header("Location: register_j2.php");
            exit();
          } 
          else {
