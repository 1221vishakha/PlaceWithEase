      ...
      {         
        ...
        else 
        {
          ...
          {               
            ...
            $sql = "INSERT INTO `senior` (`sno`, `email`, `name`, `grad_year`, `course`, `password`, `link`, `time_to_register`) 
                    VALUES (NULL, '$email', '$name', '$gyear', '$course', '$hash', '$url', current_timestamp());";
