...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4><strong>Review Content</strong></h4>
                <div class="table-responsive">
                    <table id="mytable" class="table table-bordred table-striped">
                        ...
                        <tbody>
                            ...
                            $sql="SELECT * FROM content WHERE spam >= 5";
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                              ...
                              //  $s_email = $row['posted_by']; 
                                ...
                                <td>'.$spam_count.'</td>
                                <td>
                                    <a href="'.$link1.'"><i class="fa fa-trash"></i></a> 
                                    <span>
                                    
                                        <a href="'.$link2.'" class="btn btn-primary ml-3 p-0 text-light" 
                                        style="width: 3.5em; height: 1.5em; font-size:13px;">View
                                        </a></span>
                                </td>
                            </tr>
                                ';
