      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
            <h4><b>Hope you get your desired results!!!</b></h4>
          </div>
        </div>
      </div>
    </div>
              ...
              <?php 
                ...
                while($row=mysqli_fetch_assoc($result)) {
                  ...
                  echo " 
                    ...
                    if($snum == 1) {
                      echo "
                          <form action='strategy_j.php' method='POST' novalidate='novalidate'>
  ...
  <!--  
    <script>
      ...
      function report_update(id) {
        var cur_count=jQuery('#report_loop_'+id).html();
        cur_count++;
        jQuery('#report_loop_'+id).html(cur_count);
        jQuery.ajax({
