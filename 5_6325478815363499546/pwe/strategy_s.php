  ...
  <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['share'])) {     // post content
      ...
      if (empty($_POST["content"])) {
        $contentErr = "This field is empty!";
      } 
      else {
      ...
      if($check == 2) {
        ...
        $sql = "SELECT * FROM content WHERE `data` = '$content' AND posted_by = '$email'";
        ...
        if($num < 1) {
          ...
          $sql = "INSERT INTO `content` (`c_id`, `posted_by`, `date`, `ctype`, `data`, `company`, `spam`) 
                  VALUES (NULL, '$email', current_timestamp(), '$type', '$content', NULL, '0');";
          ...
          foreach ($_POST['course'] as $subject) {
            // query
            // todo- get c_id by select c_id from content 
          ...
          //header("location: strategy_s.php");          
        }
        else
          $contentErr = $companyErr = $courseErr = $content = $company = $course = "";
      }
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="row">
              ...
              <input type="hidden" name="type" id="type" value="strategy" />
              <div class="col-lg-3 col-md-3 col-sm-12 p-1">
               ...
               // echo "$num";
                ...
                while($row=mysqli_fetch_assoc($result)) {
                  ...
                  echo " 
                    ...
                    if($snum == 1) {
                      echo "
                          <form action='strategy_s.php' method='POST' novalidate='novalidate'>
